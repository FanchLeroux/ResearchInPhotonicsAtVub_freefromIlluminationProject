...
function [ r ] = finiteDistanceLambertianSource2circularTopHat_XYpolynomials_c( args )
...
function [r] = BeginApplication(TheApplication, ~)
    ...
    zemaxFileName = dirc + "finiteDistanceLambertianSource2circularTopHat_XYpolynomials_c.zos";    
